...
@NamedQueries({
    ...
    @NamedQuery(name = "Professor.findByTitulo", query = "SELECT p FROM Professor p WHERE p.titulo = :titulo"),
...
public class Professor implements Serializable {
    ...
    public Professor(Integer id, String titulo, String nome, String email) {
        this.id = id;
        this.titulo = titulo;
        this.nome = nome;
        this.email = email;
    ...
    public String toString() {
        return "abmv.Entidade.Professor[ id=" + id + " ]";
    }
